...
//debug($result);
?>
<a href="<?php echo site_url().'admin/post_survey'; ?>" class="btn btn-primary"  style="float:right;margin-bottom:10px">Back</a>
...
<form method="post" action="" style="padding-left:30px" class="well">
    ...
    <label>7. Did you meet your goal for the Fit Family Challenge for this session?</label><br>
