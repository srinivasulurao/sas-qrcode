...
<table class="table table-stripped redbar" style="margin-top:20px" width="'100%">
    ...
    <?php foreach($results as $key):  ?>
        ...
        <tr>
            ...
            <td align="center"><a href="<?php echo site_url()."admin/view_pre_survey/".$key['ID']; ?>" class="btn btn-primary"><i class='glyphicon glyphicon-eye-open'></i> View Pre Survey</a></td>
        </tr>
    <?php endforeach; ?>
    <?php
    if(!sizeof($results))
